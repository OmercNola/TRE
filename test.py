...
from tre_based_on_boolq import train_TRE, eval_TRE, train_TRE_with_markers
...
if __name__ == '__main__':
    ...
    with warnings.catch_warnings():
        ...
        # test_dataloader = DataLoader(TRE_test_data, batch_size=2, shuffle=False)

        # Training / evaluation:
        train_TRE_with_markers(model, args, train_dataloader, tokenizer, num_epochs=10)
        # eval_TRE(model, args, train_dataloader, tokenizer)
        "====================================================================================================="
        "TRE 4 models"
