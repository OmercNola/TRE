...
def give_me_new_context_from_tokens_and_two_eids(elements_, eid1_, eid2_):
    """
    :param elements_:
    :param eid1_:
    :param eid2_:
    ...
    for key in list(TimeBank_labeled_data.keys()):
        ...
        for instance in TimeBank_labeled_data[key]:
            ...
            try:
                eid1 = Map[f'ei{eiid1}']
                eid2 = Map[f'ei{eiid2}']
                passage = give_me_new_context_from_tokens_and_two_eids(text_elements, eid1, eid2)
...
def give_me_new_context_with_markers_from_tokens_and_two_eids(elements_, eid1_, eid2_):
    """
    :param elements_:
    :param eid1_:
    :param eid2_:
    ...
    for key in list(TimeBank_labeled_data.keys()):
        ...
        for instance in TimeBank_labeled_data[key]:
            ...
            try:
                eid1 = Map[f'ei{eiid1}']
                eid2 = Map[f'ei{eiid2}']
                passage = give_me_new_context_with_markers_from_tokens_and_two_eids(text_elements, eid1, eid2)
                data_.append([passage, instance])
            except:
                pass
    print(f'len of data: {len(data_)}')
